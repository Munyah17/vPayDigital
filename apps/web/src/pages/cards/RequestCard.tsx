    ...
    <div className="p-4 lg:p-6 max-w-2xl mx-auto space-y-6">
      ...
      <div className="glass-card p-6 lg:p-8">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            <h1 className="font-display font-bold text-white text-xl">Request a virtual card</h1>
            <p className="text-white/40 text-sm">Submit a request — an agent will issue and load your card</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit((d) => request.mutate(d))} className="space-y-4">
          ...
          <div>
            <label className="block text-white/60 text-sm mb-1.5">Requested load amount</label>
            ...
            <p className="text-white/30 text-xs mt-1">How much you'd like loaded on the card (agent discretion applies)</p>
          </div>

          <div>
            <label className="block text-white/60 text-sm mb-1.5">Notes <span className="text-white/30">(optional)</span></label>
            <textarea
              {...register('notes')}
              rows={2}

...
export default function Profile() {
  ...
  return (
    <div className="p-4 lg:p-6 max-w-2xl mx-auto space-y-6">
      <h1 className="font-display font-bold text-foreground text-2xl">Profile</h1>

      {/* Avatar + summary */}
      <div className="glass-card p-6">
        <div className="flex items-center gap-4 mb-6 pb-5 border-b border-foreground/5">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-foreground font-display font-bold text-lg truncate">{profile.full_name}</p>
            <p className="text-foreground/40 text-sm truncate">{profile.email}</p>
        ...
        <form onSubmit={handleSubmit((d) => update.mutate(d))} className="space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label className="block text-foreground/60 text-sm mb-1.5">Full name <span className="text-red-400">*</span></label>
            ...
            <div>
              <label className="block text-foreground/60 text-sm mb-1.5">Display name</label>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-foreground/60 text-sm mb-1.5">Nationality</label>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label className="block text-foreground/60 text-sm mb-1.5">Date of birth</label>
              <input
          ...
          <div>
            <label className="block text-foreground/60 text-sm mb-1.5">Address</label>
            <textarea
              {...register('address')}
              rows={2}

    ...
    <div className="p-6 lg:p-8 max-w-5xl mx-auto space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="font-display font-bold text-white text-2xl">Issue Virtual Card</h1>
            <p className="text-white/30 text-sm">Issue cards directly to any user from the master float</p>
          </div>
        </div>
        <div className="panel px-4 py-2.5 text-right">
          <p className="text-white/30 text-xs">Master Float</p>
          ...
          <div className="space-y-1 max-h-64 overflow-y-auto">
            ...
            {filteredUsers.length === 0 && (
              <div className="flex flex-col items-center py-8 text-center">
                <User className="w-6 h-6 text-white/10 mb-2" />
          ...
          {selectedUser ? (
            <>
              <div className="rounded-xl bg-indigo-600/10 border border-indigo-500/20 px-3 py-2.5 flex items-center gap-3">
                ...
                <div>
                  <p className="text-white text-xs font-medium">{selectedUser.full_name}</p>
                  <p className="text-white/40 text-[10px]">{selectedUser.email}</p>
                </div>
              </div>

              <div>
                <label className="block text-white/50 text-xs mb-1.5">Cardholder Name (max 26 chars)</label>
                <input
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-white/50 text-xs mb-1.5">Network</label>
                ...
                <div>
                  <label className="block text-white/50 text-xs mb-1.5">Card Type</label>
                  <div className="relative">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-white/50 text-xs mb-1.5">Currency</label>
                  <div className="relative">
                ...
                <div>
                  <label className="block text-white/50 text-xs mb-1.5">Load Amount</label>
                  <input
            ...
            <div className="flex flex-col items-center justify-center py-16 text-center">
              ...
              <p className="text-white/20 text-sm">Select a recipient on the left</p>
            </div>
          )}
        </div>
      </div>
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              <p className="text-white text-sm font-medium">Card issued successfully</p>
